...
class AdminMenu
{
    ...
    public function register_menu(): void
    {
        ...
        // Add the top-level "Parent" item (Content Core)
        add_menu_page(
        ...
        // Add the top-level "Structure" item
        add_menu_page(
            __('Structure', 'content-core'),
            __('Structure', 'content-core'),
            'manage_options',
            'cc-structure',
            '', // No direct callback, will default to first submenu
            'dashicons-networking',
            31
        );

        // Add the top-level "Settings" item
        add_menu_page(
            __('CC Settings', 'content-core'),
            __('CC Settings', 'content-core'),
            'manage_options',
            'cc-settings-hub',
            '', // No direct callback, will default to first submenu
        ...
        // Submenu: Diagnostics -> Content Core
        add_submenu_page(
            'content-core',
        ...
        // Submenu: Field Groups -> Structure
        ...
        // Submenu: Manage Terms -> Structure
        ...
        if ($site_options_admin) {
            add_submenu_page('cc-settings-hub', __('Site Options', 'content-core'), __('Site Options', 'content-core'), 'manage_options', 'cc-site-options', [$site_options_admin, 'render_page']);
        }
                        ...
                        <div style="display:flex; align-items:center; gap:24px; flex-wrap:wrap;">
                            ...
                            <?php if ($plugin->is_module_active('rest_api')): ?>
                                <a href="<?php echo admin_url('admin.php?page=cc-api-info'); ?>" class="cc-quick-link"
                                    style="display:flex; align-items:center; gap:8px; text-decoration:none; color:var(--cc-text); font-weight:600; font-size:14px;">
                                    <span class="dashicons dashicons-rest-api"
                                        style="font-size:18px; color:var(--cc-primary);"></span>
                            ...
                            <a href="<?php echo admin_url('admin.php?page=cc-site-settings#multilingual'); ?>"
                                class="cc-quick-link"
                                style="display:flex; align-items:center; gap:8px; text-decoration:none; color:var(--cc-text); font-weight:600; font-size:14px;">
            ...
            <div class="cc-card cc-card-full" style="margin-top:24px;">
                ...
                <div style="overflow-x:auto;">
                    <table class="wp-list-table widefat fixed striped"
                        style="border:1px solid var(--cc-border); box-shadow:none;">
                        <thead>
                            <tr>
            ...
            <div class="wrap content-core-admin">
                ...
                <nav class="nav-tab-wrapper" style="margin-bottom:24px;">
                    ...
                    <a href="<?php echo esc_url(add_query_arg('tab', 'runtime-audit', $tab_base)); ?>"
                        class="nav-tab<?php echo $active_tab === 'runtime-audit' ? ' nav-tab-active' : ''; ?>">
    ...
    public function maybe_render_footer_audit(): void
    {
        if (isset($_GET['cc_audit']) && current_user_can('manage_options')) {
            RuntimeAuditRenderer::render_footer();
        }
    }
}