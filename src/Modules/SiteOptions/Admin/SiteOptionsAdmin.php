...
class SiteOptionsAdmin
{
    ...
    {
        if (strpos($hook, 'cc-site-options') === false) {
            return;
        }
                            ...
                            <div class="postbox">
                                ...
                                <div class="inside">
                                    <div style="margin-bottom: 15px;">
                                        <label
                                            style="display: block; margin-bottom: 5px; font-weight: 600;"><?php _e('Current Language', 'content-core'); ?></label>
                                    ...
                                    <div style="margin-bottom: 15px;">
                                        <label
                                            style="display: block; margin-bottom: 5px; font-weight: 600;"><?php _e('Translation Group ID', 'content-core'); ?></label>
                                        <input type="text" class="widefat" value="<?php echo esc_attr($group_id); ?>" readonly
                                            disabled style="background: #f0f0f1; color: #646970;">
                                    </div>

                                    <div class="cc-translations-list">
                                        <p
                                            style="font-weight: 600; margin-bottom: 8px; border-bottom: 1px solid #f0f0f1; padding-bottom: 5px;">
                                                ...
                                                <?php foreach ($languages as $lang):
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding: 8px 0; text-align: right; vertical-align: middle;">
                                                            <?php if ($exists): ?>
                                                                <a href="<?php echo esc_url(add_query_arg('lang', $lang['code'])); ?>"
                                                                    class="button button-small"
                                                                    title="<?php _e('Edit', 'content-core'); ?>">
                                                                    <span class="dashicons dashicons-edit"
                                                                        style="font-size: 16px; margin: 2px 4px 0 0;"></span>
                                                                    <?php _e('Edit', 'content-core'); ?>
                                                                </a>
                                                                <?php
                                                            else: ?>
                                                                <a href="<?php echo esc_url(wp_nonce_url(add_query_arg(['action' => 'cc_create_site_options_translation', 'lang' => $lang['code']]), 'cc_create_site_options_translation_' . $lang['code'])); ?>"
                                                                    class="button button-small"
                                                                    title="<?php _e('+ Create', 'content-core'); ?>">
                                                                    <span class="dashicons dashicons-plus"
                                                                        style="font-size: 14px; margin: 3px 2px 0 0;"></span>
                                    ...
                                    <div id="major-publishing-actions" style="margin: -12px; background: #fff; border: none;">
                                        <div id="publishing-action" style="padding: 12px; text-align: right;">
                                            <input type="submit" name="save" id="publish"
                                                ...
                                                value="<?php _e('Site Options speichern', 'content-core'); ?>">
                                        </div>
                                        <div class="clear"></div>
                                    </div>
                                </div>
